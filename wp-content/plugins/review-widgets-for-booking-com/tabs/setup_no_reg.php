...
1. <?php echo TrustindexPlugin::___('Connect %s platform', [ 'Booking.com' ]); ?>
</h1>
...
<?php endif; ?>
<div class="ti-box">
<div class="ti-header"><?php echo TrustindexPlugin::___('See a %s Widget example below:', [ 'Booking.com reviews' ]); ?></div>
<div class="ti-preview-box">
<?php echo $trustindex_pm_booking->get_trustindex_widget('61070ea362a62567c4bea3f50'); ?>
</div>
</div>
...
<div class="notice notice-warning" style="margin: 0 0 15px 0">
<p>
<?php echo TrustindexPlugin::___('There are no reviews on your %s platform.', [ 'Booking.com' ]); ?>
</p>
</div>
<?php else: ?>
...
<div class="preview">
<?php echo $trustindex_pm_booking->get_noreg_list_reviews(null, true, $id, 'light-background', true); ?>
</div>
</div>
</div>
<?php endforeach; ?>
...
<div class="preview">
<?php echo $trustindex_pm_booking->get_noreg_list_reviews(null, true, $style_id, $id, true); ?>
</div>
</div>
</div>
<?php endforeach; ?>
...
<div class="preview">
<div id="ti-review-list"><?php echo $trustindex_pm_booking->get_noreg_list_reviews(null, true); ?></div>
...
<a class="btn-text" href="https://www.trustindex.io/ti-redirect.php?a=sys&c=wp-booking-2" target="_blank"><?php echo TrustindexPlugin::___('Create a Free Account for More Features'); ?></a>
</div>
<?php endif; ?>
<?php endif; ?>